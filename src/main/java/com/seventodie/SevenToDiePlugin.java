...
public class SevenToDiePlugin extends JavaPlugin {
    ...
    private void checkDependencies() {
        ...
        if (!worldEditPresent) {
            getLogger().warning("WorldEdit is not installed. Advanced structure manipulation will be limited.");
        }
        ...
        if (!protocolLibPresent) {
            getLogger().warning("ProtocolLib is not installed. Some custom rendering features will be disabled.");
        }
    }
